...
const Product = ({ post }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-white hover:scale-105 transition-transform duration-300 ease-in-out gap-3 p-4 mt-10  rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:shadow-[0px_0px_95px_53px_#00000024]">
      <div>
